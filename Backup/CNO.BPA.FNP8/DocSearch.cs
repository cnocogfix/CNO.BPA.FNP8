...
{      
   ...
   /// </summary> 
   public class DocSearch : CNO.BPA.FNP8.IDocSearch
   {
      #region Variables
      ...
      public string Search(IUserConnection UserConn, ISearchInfo searchInfo)
      {
         try
         {
            if (null != searchInfo.ObjectStores)
            {
               ...
               IRepositoryRowSet rowSet = searchScope.FetchRows(sqlObject, null, null, false);
               #endregion
                  ...
                  foreach (IProperty rowprop in row.Properties)
                  {
                     ...
                     switch (DataType)
                     {
                        ...
                        case "FileNet.Apiimpl.Property.PropertyEngineObjectImpl":
                           ...
                           {
                              if (rowprop.GetPropertyName() == "ClassDescription")
                              {
                                 IClassDescription clDescription = (IClassDescription) rowprop.GetObjectValue();
                                 value = clDescription.Name.ToString();
                              }
                              else
                              {
                        ...
                        case "FileNet.Apiimpl.Property.PropertyStringListImpl":
                           if (rowprop.GetState() == PropertyState.VALUE)
                           {
                              ...
                              {
                                 if (propname == "ContentElementsPresent")
                                 {
                                    pages++;
                                 }
                                 else
